...
class log implements ServiceProviderInterface
{
	public function register(Application $app)
	{
		...
		$app['monolog'] = $app->share(function (builder\application $app) {
			$log = new Logger(isset($app['monolog.name']) ? $app['monolog.name'] : 'builder');
		...
		$app['monolog.listener'] = $app->share(function (builder\application $app) {
